...
import com.stocat.auth.core.exception.ErrorCode;
import com.stocat.auth.core.exception.ErrorDomain;
...
public enum AuthErrorCode implements ErrorCode {
    ...
    USER_NOT_FOUND(ErrorDomain.AUTH.offset() + 5, "회원 정보를 찾을 수 없습니다.");
